...
$db['dev']['password'] = '';
$db['dev']['database'] = 'aysarkco_coursechamp';
...
$db['production']['username'] = 'studygig_user';
$db['production']['password'] = '1course1';
$db['production']['database'] = 'studygig';
$db['production']['dbdriver'] = 'mysql';
$db['production']['dbprefix'] = '';
$db['production']['pconnect'] = TRUE;
$db['production']['db_debug'] = TRUE;
$db['production']['cache_on'] = FALSE;
$db['production']['cachedir'] = 'application/db_cache/';
